        ...
        <div  className={styles.whol}>
            <div className={styles.ndy} >
               ...
               <div className={styles.secon}>
                <div className={styles.circ}><img src="https://th.bing.com/th/id/OIP.9yCexsNPgd52WLyrdhBlOwHaHa?pid=ImgDet&rs=1"/></div>
                <div className={styles.numb}>Step-2</div>
                <div className={styles.namej}>Search and apply for jobs</div>
               </div>

               <div className={styles.third}>
                <div className={styles.circ}><img src="https://cdn1.iconfinder.com/data/icons/colored-hand-phone/96/Whatsapp-mobile_phone-512.png"/></div>
                <div className={styles.numb}>Step-3</div>
                <div className={styles.namee}>Directly call or Whatsapp employers</div>
               </div>


               <div className={styles.four}>
                <div className={styles.circ}><img src="https://image.flaticon.com/icons/png/512/1256/1256676.png"/></div>
